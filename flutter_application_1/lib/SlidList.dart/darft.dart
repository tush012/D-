...
//                     }
//                     Map<String,dynamic> data={"Customer Name":CName.text,"Number":Number.text,"Product":Product.text
//                     ,"Price":Price.text};
//                     FirebaseFirestore.instance.collection("items").add(data);
//                   }, child: Text("Submit")),
//                   ElevatedButton(onPressed: (){
//       // ElevatedButton async{
//       //   DocumentSnapshot variable=await FirebaseFirestore.instance.collection('items').doc('LjtrQELyw27Qc5Mry6pK'.get();
//       //}
//                   }, child: Text("getData")),
//           ],
//               ),
